  ...
  default = [
    {
      ...
      callback_urls        = ["http://localhost:5212/"]
      default_redirect_uri = "http://localhost:5212/"
      generate_secret      = true
    }
  ]
}
...
#   default     = "aws_lambda_function.cognito-define-auth-challenge-lambda.arn"
# }
...
#   default     = "aws_lambda_function.cognito-post-confirmation-lambda.arn"
# }
